...
public class UserConstant {
	...
	/** The Constant URL_FLIGHT_HISTORY. */
	public static final String URL_FLIGHT_HISTORY = "flighthistory";

	/** The Constant URL_USER_SIGNUP. */
	public static final String URL_USER_SIGNUP = "signup";

	/** The Constant URL_USER_LOGIN_. */
